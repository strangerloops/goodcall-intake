...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        startButton.setTitle("Collect User Information", for: .normal)
        ...
        count.text = "\(Config.archivedCount()) saved users"
        ...
        sendButton.setTitle("Add users to Good Call's database", for: .normal)
